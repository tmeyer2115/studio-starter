...
const CTASectionCentered = (props: CTASectionCenteredProps) => {
  const { heading, paragraph, cta1Label, cta1Color, cta2Label, cta2Color } = props;
            ...
            <div className="py-24 px-6 sm:px-6 sm:py-32 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    ...
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        ...
                        <a href="#" className="text-base font-semibold leading-7 text-gray-900" style={cta2Styling}>
